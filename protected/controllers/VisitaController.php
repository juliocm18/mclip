...
class VisitaController extends Controller
{
	...
	public function actionDetalle()
	{
		if(isset($_POST['id_detalle']))
		{
			...
			Yii::app()->session['s_hist']='historico';
			$this->render('detalle',array(
				'model'=>$this->loadModel($_POST['id_detalle']),
			));
		}
		else
		{
	...
	public function actionDelete($id)
	{
		try{
		    ...
		    if(!isset($_GET['ajax']))
		        Yii::app()->user->setFlash('error','No se puede eliminar Visita');
		    else
		        echo "<div class='flash-error'>No se puede eliminar Visita </div>"; //for ajax
		}
